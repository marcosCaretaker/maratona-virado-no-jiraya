package academy.marcoscaretaker.maratonajava.javacore.Dconstructor.domain;
...
public class Anime {
    ...
    public Anime(String title, String type, int episodes, String genre){
        this();
        this.title = title;
        this.type = type;
    ...
    public Anime(String title, String type, int episodes, String genre, Studio studio){
        this(title,type,episodes,genre);
        this.studio = studio;
    }
